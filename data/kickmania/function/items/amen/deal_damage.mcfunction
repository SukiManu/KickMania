...
execute store result entity @s Motion[0] double 0.023 run scoreboard players get $dx temp
execute store result entity @s Motion[1] double 0.016 run scoreboard players get $temp0 temp
execute store result entity @s Motion[2] double 0.023 run scoreboard players get $dz temp

scoreboard players set $damage temp 700

#tellraw @a {"score":{"name": "distance","objective": "temp"}}
