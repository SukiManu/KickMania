...
execute store result entity @s Motion[0] double 0.0063 run scoreboard players get $dx temp
execute store result entity @s Motion[1] double 0.032 run scoreboard players get $temp0 temp
execute store result entity @s Motion[2] double 0.0063 run scoreboard players get $dz temp
