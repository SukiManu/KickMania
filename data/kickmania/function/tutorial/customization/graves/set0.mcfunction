$execute store result score $result temp run data modify storage minecraft:kickmania player_list[{id:$(id)}].grave_model set value 20000
scoreboard players set @s grave_skin 20000
