...
execute store result entity @s Motion[0] double 0.004 run scoreboard players get $dx temp
execute store result entity @s Motion[1] double 0.003 run scoreboard players get $dy temp
execute store result entity @s Motion[2] double 0.004 run scoreboard players get $dz temp

scoreboard players set $damage temp 200
